const translations = {
  zh: {
    ...
    bikePageTitle: "共享单车需求预测 · Actor.D｜个人主页",
    bikePageDescription:
      "Actor.D 的数据挖掘课程作业——共享单车租借量预测：10,886 行训练数据，SKLearn MLP 与 Keras 两个神经网络模型的对照。",
    riderPageTitle: "骑手数字劳动研究 · Actor.D｜个人主页",
    riderPageDescription:
      "Actor.D 参与的大数据黑客松项目——外卖骑手数字劳动异化研究：75 份问卷、2 位骑手深访、配送时间预估与贪心调度两个 C++ 模型。",
    ...
    nav: { about: "关于我", projects: "项目案例", analysis: "数据分析", vision: "图像识别", rider: "骑手研究", research: "研究论文", journey: "学习经历", contact: "联系我" },
    common: {
      backHome: "回到主页",
    ...
    moreProjects: {
      title: "更多项目",
      hackathonType: "社会数据研究 · 大数据黑客松",
      hackathonTitle: "骑手仍被困在系统里",
      hackathonBody:
        "75 份消费者问卷 + 2 位骑手深访 + 2 个 C++ 配送模型：从受访骑手口述推算，同一条 2km 订单的规定时限由 32 分钟压缩到 29 分钟（−9.4%），并用贪心调度模拟订单分配机制。",
      petType: "计算机视觉 · CNN",
      petTitle: "猫狗图像分类与动漫对照实验",
      petBody:
        "从零搭建 4 块 CNN（511 万参数），25,000 张实拍图测试准确率 95.12%；追加 2,000 张自爬动漫图后重训，真实图精度下降约 1.2 个百分点。",
      ...
      bikeTitle: "共享单车需求预测",
      bikeBody:
        "Kaggle Bike Sharing Demand：10,886 行逐小时数据，在同一份 70/30 随机划分上对照 SKLearn MLP 与 Keras 两个神经网络，最优 RMSLE 0.29（MLP 的 RMSE 43.48 优于 Keras）。",
      viewAnalysis: "查看完整分析",
    },
    danmu: {
      title: "弹幕文本分析",
    ...
    rider: {
      title: "骑手仍被困在系统里",
      lead: "平台逻辑下数字劳动异化的研究——把消费者问卷、骑手深访和配送建模三条证据放在一起看。",
      pageKicker: "大数据黑客松 · 四人团队项目",
      name: "数字劳动异化研究",
      subtitle: "以外卖骑手为例：75 份消费者问卷 + 2 位骑手深访 + 2 个配送模型",
      summary:
        "数字平台用算法接管了骑手的工作路径、时间与收益，骑手却对规则缺乏透明度与话语权。我们一边测量消费者侧的态度（配送时间与餐品完整度谁更重要、超时接受度、责任归因），一边通过深度访谈记录骑手侧的真实处境，再用两个 C++ 模型分别估算配送时间、模拟贪心调度的订单分配，尝试把「被困在系统里」这一感受拆成可验证的机制。",
      viewArtifacts: "查看原始材料",
      factSurvey: "份有效问卷",
      factQuestions: "道问卷题目",
      factInterview: "位骑手深度访谈",
      factModels: "个 C++ 配送模型",
      methodEyebrow: "研究方法",
      methodTitle: "三条证据，三个视角",
      methodIntro: "单一视角容易把问题讲成情绪；我们刻意从消费者、劳动者、系统三个方向各取一份证据。",
      m1Title: "消费者问卷",
      m1Body: "19 道题覆盖点餐习惯、超时与倾倒的接受度、责任归因、骑手职业危险评分与刻板印象，共回收 75 份有效问卷。",
      m2Title: "骑手深度访谈",
      m2Body: "在杭州西湖区对两位骑手做半结构化访谈，各 10 个问题，覆盖入行原因、最耗时环节、违章心态、平台规则与收入。",
      m3Title: "配送建模",
      m3Body: "一个模型按天气、交通、路况与红绿灯估算配送时间，另一个用贪心策略模拟多骑手多订单的调度与取消。",
      surveyEyebrow: "消费者侧",
      surveyTitle: "比超时更不能接受的，是餐没送好",
      surveyIntro: "75 份问卷里最反直觉的一组对比：消费者对餐品完整度的在意程度接近配送时间的两倍。",
      tblMetric: "指标",
      tblValue: "结果",
      tblMeaning: "含义",
      rowWeight: "重视程度",
      rowWeightNote: "餐品完整度的重要性接近时间的两倍",
      rowTimeout: "超时接受度",
      rowTimeoutNote: "能容忍的延迟比例",
      rowSpill: "倾倒接受度",
      rowSpillNote: "容忍度明显低于超时",
      rowBlame: "责任归因",
      rowBlameNote: "四成责任被认为不可归咎于个人",
      rowDanger: "职业危险评分",
      rowDangerNote: "30% 的人给出 8 分",
      rowWindow: "认为时间区间合理",
      rowWindowNote: "多数消费者并不认为平台时限过紧",
      rowImage: "职业印象",
      rowImageNote: "同情与污名同时存在",
      surveyNote: "另外：88.33% 的消费者从未给过差评，但「马路杀手」的标签仍有 49.33% 的人勾选——说明公众对骑手的态度是分裂的。",
      interviewEyebrow: "骑手侧",
      interviewTitle: "访谈里最刺人的两句原话",
      interviewIntro: "这部分不是数据，但它是问卷问不出来的东西——规则如何被骑手亲身体验。",
      quote1: "「我一开始送一个 2km 的外卖，它给我规定的时间是 32 分钟。因为我抄近路、闯红灯、逆行，每次大概 28 分钟送到。结果前不久我发现它规定的时间就缩短到 29 分钟了。既然路线没变，为什么把我时间缩短？」",
      quote1Caption: "张先生（20 余岁，从业一年）—— 这是整份研究里最关键的证据：骑手用违规换来的时间，会被算法当成新的基准。",
      quote2: "「最开始送外卖的时候其实是没有（违章）的。但随着订单数增多，我们时间就很紧。现在有时候都是无意识的，只想快点加快速度好配送下一单，千万不能超时。」",
      quote2Caption: "刘先生（40 余岁，从业三年）—— 违章不是安全意识问题，而是时间压力下的条件反射。",
      deriveTitle: "从口述推出的时间压缩",
      deriveBody: "同一条 2km 订单的规定时限，从 32 分钟被下调到 29 分钟，降幅 9.4%。需要说明：这个百分比是我们就访谈内容自己计算的，原始材料中并没有这句结论。",
      contextTitle: "受访骑手的共同处境",
      contextBody: "两人都把「等餐」与「等顾客」视为最耗时的环节，而计时从接单那一刻开始；平台导航给出过逆行路线与不可通行的天桥；超时与差评的损失全部由骑手承担。",
      modelEyebrow: "建模部分",
      modelTitle: "把配送过程写成可计算的形式",
      modelIntro: "两个 C++ 程序：一个估时，一个调度。它们回答的是「平台是怎么算出那个时间的」。",
      etaEyebrow: "模型一 · 配送时间预估",
      etaTitle: "多因子速度衰减",
      etaOne: "骑手速度取自截断正态分布，保留现实中的随机波动",
      etaTwo: "交通修正：畅通不变，中等 −20%，拥堵 −40%",
      etaThree: "天气修正：晴不变，雨 −25%，雪 −50%",
      etaFour: "路况修正：良好不变，一般 −15%，糟糕 −30%",
      etaFive: "叠加红绿灯等待，最终输出 90%–110% 的时间区间",
      dispatchEyebrow: "模型二 · 调度模拟",
      dispatchTitle: "贪心最近配送",
      dispatchOne: "三个结构体：Order（坐标、优先级）、Rider（负载）、Traffic（拥堵等级）",
      dispatchTwo: "新订单分配给直线距离最近的骑手",
      dispatchThree: "路径优化用贪心策略：每次选离当前坐标最近的未访问订单",
      dispatchFour: "模拟 100 个时间单位，含随机交通变化与订单取消",
      dispatchFive: "拥堵时按订单优先级重排配送顺序",
      modelCaveat:
        "需要说明：这两个程序是理论模型，用来演示机制与做敏感性推演，并未接入真实路网数据或平台接口，因此没有「效率提升」这类实测结论——早期版本的网页文案曾把道路条件系数 15% 误写成效率提升，现已更正。",
      reflectEyebrow: "局限与反思",
      reflectTitle: "这份研究没做够的地方",
      reflectIntro: "篇幅与时间限制下的取舍，如实记录。",
      issue1Title: "样本小且集中在单一城市",
      issue1Body: "75 份问卷与 2 位骑手都来自杭州，样本量不足以做统计推断；访谈对象也只有 2 人，个体差异无法与群体规律区分。",
      issue2Title: "缺少骑手侧的量化对照",
    ...
    bike: {
      title: "共享单车需求预测",
      lead: "用两个神经网络在同一条基线上做回归——SKLearn 的 MLP 与 Keras，并解释高峰与天气如何影响租借量。",
      pageKicker: "数据挖掘与机器学习 · 第 14 组课程作业",
      name: "Bike Sharing Demand",
      subtitle: "以小时为粒度的租借量回归：10,886 行训练数据、2 个神经网络模型",
      summary:
        "题目来自 Kaggle Bike Sharing Demand：根据两年间逐小时记录的天气与时间信息，预测共享单车的租借数量。我们把时间字段拆成年月日与小时，对分类特征做独热编码、数值特征做标准化、对跨度大的数据取对数，然后在同一份 70/30 随机划分上分别训练 SKLearn 的 MLPRegressor 与 Keras 的 Sequential 模型，比较两者的拟合表现。",
      viewArtifacts: "查看报告与代码",
      factTrain: "行训练数据",
      factFeatures: "个原始字段",
      factRmsle: "最优 RMSLE",
      factModels: "个神经网络模型",
      compareEyebrow: "两模型对照",
      compareTitle: "同一条基线上的两次训练",
      compareIntro: "预处理、特征工程与数据划分完全一致，唯一变量是模型实现方式。",
      tblMetric: "指标",
      tblMlp: "SKLearn MLPRegressor",
      tblKeras: "Keras Sequential",
      rowArch: "网络结构",
      rowSetting: "关键设置",
      rowSettingKeras: "早停法（EarlyStopping）抑制过拟合",
      rowRmse: "RMSE",
      rowRmsle: "RMSLE",
      compareNote:
        "结论：SKLearn 的 MLP 在两个指标上都略优于 Keras。需要说明的是，Keras 的数值在不同次运行中不一致——演示文稿记录为 RMSE 48.23 / RMSLE 0.29，而 notebook 的输出是 49.22 / 0.31，报告中「两者 RMSLE 都为 0.29」的表述与 notebook 不符，此处按 notebook 与 PPT 的区间如实呈现。",
      dataEyebrow: "数据与预处理",
      dataTitle: "没有缺失值，但需要处理两件事",
      dataIntro: "数据集本身很干净，真正的难点是量纲差异过大的计数，以及形如 2011/1/1 1:00 的时间字段。",
      d1Title: "数据概况",
      d1Body:
        "训练集 10,886 行 × 12 列：日期时间、季节、是否假日、是否工作日、天气等级、气温、体感温度、湿度、风速，以及 casual / registered / count 三个计数列。",
      d2Title: "时间拆解",
      d2Body: "把 datetime 拆成 年 / 月 / 日 / 星期 / 小时 五个字段，让模型能直接学到通勤高峰与季节规律。",
      d3Title: "编码与标度",
      d3Body: "季节、天气、年、月、星期等分类特征做独热编码；气温、体感温度、湿度、风速做标准化；对差距过大的计数取对数。",
      splitNote: "数据划分：按 0.7 的比例随机切分（train 7,619 / validation 3,265），并刻意打乱顺序，避免时间顺序本身泄漏信息。",
      findEyebrow: "解释性分析",
      findTitle: "租借量被什么驱动",
      findIntro: "报告与演示文稿给出的是定性判断，尚未做特征重要性或偏依赖的定量拆解。",
      f1Title: "通勤高峰",
      f1Body: "上下班时段租借量明显更高——这也解释了为什么把小时拆出来对模型帮助很大。",
      f2Title: "天气越好，两类用户都更多",
      f2Body: "天气良好时，非注册用户与注册用户的租借量都显著上升，说明天气是需求的首要外部变量之一。",
      f3Title: "假日与非假日，租车理由不同",
      f3Body: "假日更可能来自游客等休闲需求，工作日则以上班族通勤为主——同一列 count 背后是两类不同的行为。",
      f4Title: "其余变量未继续深挖",
      f4Body: "气温、体感温度、湿度、风速都有影响，但团队判断分析过于复杂且缺少部分数据，没有进一步量化。",
      reflectEyebrow: "局限与自评",
      reflectTitle: "团队自己写下的不足",
      reflectIntro: "这部分直接来自报告与 PPT 的自评章节。",
      i1Title: "数据只覆盖 2011–2012 年",
      i1Body: "换到其他年份需要重新训练，模型本身没有跨时间的泛化保证。",
      i2Title: "未针对极端情况训练",
      i2Body: "模型没有专门训练极端天气或极端需求的样本，团队自评「泛化能力较低」。",
      i3Title: "缺少基线对照",
      i3Body: "两个神经网络之间做了比较，但没有与线性回归或「用均值预测」这类朴素基线对照，因此 0.29 这个 RMSLE 究竟好到什么程度缺少参照。",
      i4Title: "超参未做搜索",
      i4Body: "隐藏层大小、学习率、批大小等都采用了一组设定而未做调参或交叉验证，模型性能仍有提升空间。",
      engEyebrow: "工程拆解",
      engTitle: "从原始表到可复用的预测程序",
      engBody: "两个 notebook 各自独立完成一条完整链路，并把训练好的模型与预处理器一起保存，供交互式预测脚本调用。",
      e1Title: "数据理解与可视化",
      e1Body: "先绘制 count 列随时间的变化，确认高峰形态与量纲分布，再决定取对数与拆解时间字段。",
      e2Title: "列级预处理管线",
      e2Body: "用 ColumnTransformer 把独热编码与标准化按列并行处理，管线对象一并持久化为 joblib 文件。",
      e3Title: "SKLearn 回归",
      e3Body: "MLPRegressor 单隐藏层 100 神经元，训练后用 RMSE 与 RMSLE 双指标评估，并可视化残差分布。",
      e4Title: "Keras 回归 + 早停",
      e4Body: "Sequential 构建同规模网络，用早停法在验证损失不再下降时停止训练，抑制过拟合。",
      navPrev: "上一个项目：骑手数字劳动研究",
    },
    research: {
      title: "研究论文",
      expandAbstract: "展开全文",
  ...
  en: {
    ...
    bikePageTitle: "Bike-Sharing Demand Forecasting · Actor.D | Personal Website",
    bikePageDescription:
      "Actor.D's data-mining coursework: hourly bike-rental forecasting on 10,886 rows, comparing a SKLearn MLP with a Keras neural network.",
    riderPageTitle: "Rider Digital Labour Study · Actor.D | Personal Website",
    riderPageDescription:
      "Actor.D's big-data hackathon project: digital labour alienation among food-delivery riders — 75 surveys, two in-depth rider interviews, and two C++ delivery models.",
    ...
    nav: { about: "About", projects: "Project", analysis: "Analytics", vision: "Vision", rider: "Rider Study", research: "Research", journey: "Journey", contact: "Contact" },
    common: {
      ...
      nextRider: "Continue: the rider study",
      nextBike: "Continue: the bike-share forecast",
    ...
    moreProjects: {
      title: "More projects",
      hackathonType: "Social data study · Big Data Hackathon",
      hackathonTitle: "Riders Are Still Trapped in the System",
      hackathonBody:
        "75 consumer surveys, two in-depth rider interviews and two C++ delivery models: a rider's account implies the allotted window for the same 2 km order fell from 32 to 29 minutes (−9.4%), with greedy dispatch simulated to model order allocation.",
      ...
      bikeType: "Machine learning · Regression",
      bikeTitle: "Bike-Sharing Demand Forecasting",
      bikeBody:
        "Kaggle Bike Sharing Demand: 10,886 hourly records, with a SKLearn MLP and a Keras network trained on the same randomised 70/30 split — best RMSLE 0.29, and the MLP's RMSE of 43.48 beats Keras.",
    ...
    rider: {
      title: "Riders Are Still Trapped in the System",
      lead: "A study of digital labour alienation under platform logic — consumer survey, rider interviews and delivery modelling read together.",
      pageKicker: "BIG DATA HACKATHON · TEAM OF FOUR",
      name: "Digital labour alienation",
      subtitle: "Food-delivery riders as the case: 75 consumer surveys, 2 rider interviews, 2 delivery models",
      summary:
        "Platform algorithms decide a rider's route, timing and earnings, while riders have little transparency or say over the rules. We measured consumer attitudes, recorded riders' own accounts through in-depth interviews, and built two C++ models — one estimating delivery time, one simulating greedy dispatch — to break the feeling of being trapped into mechanisms that can be examined.",
      viewArtifacts: "Browse the source material",
      factSurvey: "valid survey responses",
      factQuestions: "survey questions",
      factInterview: "in-depth rider interviews",
      factModels: "C++ delivery models",
      methodEyebrow: "METHOD",
      methodTitle: "Three kinds of evidence, three perspectives",
      methodIntro: "A single viewpoint turns the problem into sentiment, so we took one piece of evidence each from consumers, workers and the system itself.",
      m1Title: "Consumer survey",
      m1Body: "19 questions covering ordering habits, tolerance for delays and spillage, blame attribution, danger ratings and stereotypes — 75 valid responses.",
      m2Title: "Rider interviews",
      m2Body: "Semi-structured interviews with two riders in Xihu District, Hangzhou, ten questions each: why they joined, the slowest steps, their attitude to violations, platform rules and income.",
      m3Title: "Delivery modelling",
      m3Body: "One model estimates delivery time from weather, traffic, road condition and traffic lights; the other simulates multi-rider, multi-order dispatch and cancellations with a greedy strategy.",
      surveyEyebrow: "CONSUMER SIDE",
      surveyTitle: "Arriving intact matters more than arriving fast",
      surveyIntro: "The most counter-intuitive comparison in the 75 responses: consumers care about food arriving intact almost twice as much as about speed.",
      tblMetric: "Metric",
      tblValue: "Result",
      tblMeaning: "Reading",
      rowWeight: "What matters",
      rowWeightNote: "Food arriving intact matters nearly twice as much as timing",
      rowTimeout: "Tolerance for late delivery",
      rowTimeoutNote: "Share of delay consumers accept",
      rowSpill: "Tolerance for spillage",
      rowSpillNote: "Markedly lower than for delay",
      rowBlame: "Blame attribution",
      rowBlameNote: "Four in ten consider the cause outside individual control",
      rowDanger: "Perceived danger",
      rowDangerNote: "30% rate it 8 out of 10",
      rowWindow: "Time windows seen as fair",
      rowWindowNote: "Most consumers do not think platform deadlines are too tight",
      rowImage: "Occupational image",
      rowImageNote: "Sympathy and stigma coexist",
      surveyNote: "Also: 88.33% of consumers have never left a bad review, yet 49.33% still tick the road-killer label — public attitudes are split.",
      interviewEyebrow: "RIDER SIDE",
      interviewTitle: "The two sharpest lines from the interviews",
      interviewIntro: "Not data, but something a survey cannot reach: how the rules are actually experienced.",
      quote1: "“When I started, a 2 km delivery was allotted 32 minutes. By cutting through side roads, running reds and going the wrong way up one-way streets, I usually made it in about 28. Not long ago I noticed the allowance had been cut to 29 minutes. The route never changed — so why was my time cut?”",
      quote1Caption: "Mr Zhang (early 20s, one year in the job) — the single most important piece of evidence here: time that riders win back by breaking rules becomes the algorithm's new baseline.",
      quote2: "“At the very beginning I didn't break any rules. But as the order count grew, our time got very tight. Now it sometimes happens without thinking — I just want to speed up for the next order, I absolutely cannot be late.”",
      quote2Caption: "Mr Liu (40s, three years in the job) — violations are not a safety-awareness problem but a reflex produced by time pressure.",
      deriveTitle: "The time squeeze, derived from testimony",
      deriveBody: "The allotted window for the same 2 km order fell from 32 to 29 minutes — a 9.4% reduction. Note: we computed that percentage ourselves from the interview; the original material never states it.",
      contextTitle: "What both riders shared",
      contextBody: "Both named waiting for food and waiting for customers as the slowest steps, while the clock starts the moment an order is accepted; the platform's navigation has routed them the wrong way up one-way streets and over bridges e-bikes may not use; and the cost of a late delivery or a bad review lands entirely on the rider.",
      modelEyebrow: "MODELLING",
      modelTitle: "Writing the delivery process as something computable",
      modelIntro: "Two C++ programs — one for timing, one for dispatch. Together they ask how the platform arrives at that number.",
      etaEyebrow: "MODEL 1 · DELIVERY TIME",
      etaTitle: "Multi-factor speed decay",
      etaOne: "Rider speed is drawn from a truncated normal distribution, keeping realistic variation",
      etaTwo: "Traffic: free flow unchanged, moderate −20%, congested −40%",
      etaThree: "Weather: clear unchanged, rain −25%, snow −50%",
      etaFour: "Road condition: good unchanged, fair −15%, poor −30%",
      etaFive: "Traffic-light waiting is added, and the output is a 90%–110% interval",
      dispatchEyebrow: "MODEL 2 · DISPATCH",
      dispatchTitle: "Greedy nearest-order routing",
      dispatchOne: "Three structs: Order (coordinates, priority), Rider (load) and Traffic (congestion level)",
      dispatchTwo: "New orders go to the rider with the shortest straight-line distance",
      dispatchThree: "Routing is greedy — always pick the nearest unvisited order from the current position",
      dispatchFour: "Runs 100 time units with randomised traffic changes and order cancellations",
      dispatchFive: "Under congestion, orders are re-ordered by priority",
      modelCaveat:
        "Note: both programs are theoretical models for demonstrating mechanism and running sensitivity checks. Neither is connected to real road-network data or platform APIs, so there is no measured efficiency gain — an earlier version of this page mistakenly presented a road-condition coefficient of 15% as an efficiency improvement. That has been corrected.",
      reflectEyebrow: "LIMITS & REFLECTION",
      reflectTitle: "Where this study falls short",
      reflectIntro: "Trade-offs made under time and length constraints, recorded honestly.",
      issue1Title: "Small sample, single city",
      issue1Body: "All 75 responses and both interviews come from Hangzhou; the sample cannot support statistical inference, and with only two interviewees individual differences cannot be separated from patterns.",
      issue2Title: "No quantitative rider-side comparison",
    ...
    bike: {
      ...
      lead: "Two neural networks on one shared baseline — SKLearn's MLP against Keras — plus a reading of how rush hour and weather move demand.",
      pageKicker: "DATA MINING & MACHINE LEARNING · GROUP 14 COURSEWORK",
      name: "Bike Sharing Demand",
      subtitle: "Hourly rental-count regression: 10,886 training rows and two neural-network models",
      summary:
        "The task comes from Kaggle's Bike Sharing Demand: predict hourly bike rentals from two years of weather and calendar records. We split the timestamp into year, month, day, weekday and hour, one-hot encoded the categorical features, standardised the numeric ones and log-transformed the wide-ranging counts. Both SKLearn's MLPRegressor and a Keras Sequential model were then trained on the same randomised 70/30 split and compared.",
      viewArtifacts: "Browse report & code",
      factTrain: "training rows",
      factFeatures: "raw columns",
      factRmsle: "best RMSLE",
      factModels: "neural-network models",
      compareEyebrow: "MODEL COMPARISON",
      compareTitle: "Two runs on one shared baseline",
      compareIntro: "Preprocessing, feature engineering and the train/validation split are identical — only the implementation differs.",
      tblMetric: "Metric",
      tblMlp: "SKLearn MLPRegressor",
      tblKeras: "Keras Sequential",
      rowArch: "Architecture",
      rowSetting: "Key settings",
      rowSettingKeras: "EarlyStopping to limit overfitting",
      rowRmse: "RMSE",
      rowRmsle: "RMSLE",
      compareNote:
        "Verdict: SKLearn's MLP edges out Keras on both metrics. Note that Keras' numbers vary between runs — the slide deck records RMSE 48.23 / RMSLE 0.29 while the notebook prints 49.22 / 0.31, and the report's claim that both models scored 0.29 does not match the notebook. The range is shown here as recorded.",
      dataEyebrow: "DATA & PREPROCESSING",
      dataTitle: "No missing values, but two things to fix",
      dataIntro: "The dataset is clean; the real work is the wildly varying counts and a timestamp shaped like 2011/1/1 1:00.",
      d1Title: "The dataset",
      d1Body:
        "10,886 rows × 12 columns: timestamp, season, holiday, working day, weather level, temperature, apparent temperature, humidity, wind speed, plus the casual / registered / count columns.",
      d2Title: "Decomposing time",
      d2Body: "The datetime column becomes year / month / day / weekday / hour so the model can learn commuting peaks and seasonality directly.",
      d3Title: "Encoding and scaling",
      d3Body: "Season, weather, year, month and weekday are one-hot encoded; temperature, apparent temperature, humidity and wind speed are standardised; wide counts are log-transformed.",
      splitNote: "Split: a randomised 70/30 cut (7,619 train / 3,265 validation), deliberately shuffled so time order does not leak information.",
      findEyebrow: "INTERPRETATION",
      findTitle: "What drives rental volume",
      findIntro: "The report and slides give qualitative readings only — no feature importance or partial dependence was computed.",
      f1Title: "Commuting peaks",
      f1Body: "Rentals rise sharply around the morning and evening commute, which is largely why extracting the hour helped the model.",
      f2Title: "Better weather, more of both user types",
      f2Body: "In good weather both casual and registered rentals rise markedly, making weather one of the primary external drivers.",
      f3Title: "Holidays and workdays rent for different reasons",
      f3Body: "Holidays likely reflect leisure demand from visitors while workdays are dominated by commuters — the same count column hides two behaviours.",
      f4Title: "The remaining variables were left unexplored",
      f4Body: "Temperature, apparent temperature, humidity and wind speed all matter, but the team judged further analysis too complex with the data available.",
      reflectEyebrow: "LIMITS & SELF-ASSESSMENT",
      reflectTitle: "Shortcomings the team recorded itself",
      reflectIntro: "Taken directly from the self-assessment sections of the report and slides.",
      i1Title: "Data covers 2011–2012 only",
      i1Body: "Other years would require retraining; the model carries no guarantee of generalising across time.",
      i2Title: "No training on extreme cases",
      i2Body: "Extreme weather or demand spikes were never specifically trained, and the team rated its own generalisation as weak.",
      i3Title: "No baseline comparison",
      i3Body: "The two neural networks were compared with each other, but not against a linear regression or a mean-prediction baseline, so an RMSLE of 0.29 has no reference point.",
      i4Title: "No hyperparameter search",
      i4Body: "Hidden-layer size, learning rate and batch size were all taken as given rather than tuned or cross-validated, leaving room for improvement.",
      engEyebrow: "ENGINEERING",
      engTitle: "From a raw table to a reusable prediction program",
      engBody: "Each notebook runs a complete pipeline end to end and persists both the trained model and the preprocessor for the interactive prediction script.",
      e1Title: "Exploration & visualisation",
      e1Body: "The count series is plotted first to confirm the peak shape and value distribution, which motivates the log transform and the time decomposition.",
      e2Title: "Column-level pipeline",
      e2Body: "A ColumnTransformer applies one-hot encoding and standardisation per column group, and the fitted pipeline is saved with joblib.",
      e3Title: "SKLearn regression",
      e3Body: "MLPRegressor with one hidden layer of 100 units, scored with both RMSE and RMSLE and with residual distributions plotted.",
      e4Title: "Keras regression with early stopping",
      e4Body: "A Sequential model of the same size, halted by EarlyStopping once validation loss stops improving.",
      navPrev: "Previous project: rider digital-labour study",
    },
    research: {
...
function setLanguage(language) {
  ...
  const pageMeta = {
    ...
    rider: ["riderPageTitle", "riderPageDescription"],
    bike: ["bikePageTitle", "bikePageDescription"],
